      ...
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Adicione uma nova transação ao sistema. Preencha todos os campos obrigatórios.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              <Label className="text-right">Tipo</Label>
              <RadioGroup value={transactionType} onValueChange={setTransactionType} className="col-span-3 flex gap-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="description" placeholder="Descrição da transação" className="col-span-3" required />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
